...
type Ref struct {
	// The full path to the indicated type, which is the last element of objects.
...
func (r *Ref) Object() types.Object {
	return r.Objects[len(r.Objects)-1]
}
...
func Eval(hits []*Hit, funcs map[string]Func, pkg *types.Package) []error {
	errs := []error{}
